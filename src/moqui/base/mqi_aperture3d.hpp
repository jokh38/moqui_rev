#ifndef MQI_APERTURE3D_HPP
#define MQI_APERTURE3D_HPP
...
template <typename T, typename R> class aperture3d : public grid3d<T, R> {
public:
  ...
  CUDA_HOST_DEVICE
  aperture3d(const R xe[], const ijk_t n_xe, const R ye[], const ijk_t n_ye,
  ...
  aperture3d(const R xe_min, const R xe_max,
      ...
      : grid3d<T, R>(xe_min, xe_max, n_xe, ye_min, ye_max, n_ye, ze_min, ze_max,
                     n_ze) {}
  ...
  aperture3d(const R xe_min, const R xe_max,
             ...
             const R ye_min, const R ye_max, const ijk_t n_ye, const R ze_min,
             const R ze_max, const ijk_t n_ze, std::array<R, 3> &angles,
             int16_t num_opening, uint16_t *num_segment,
             mqi::vec2<R> **block_segment)
      : grid3d<T, R>(xe_min, xe_max, n_xe, ye_min, ye_max, n_ye, ze_min, ze_max,
                     n_ze, angles) {
  ...
  CUDA_HOST_DEVICE
  virtual intersect_t<R> intersect(mqi::vec3<R> &p, mqi::vec3<R> &d,
                                   mqi::vec3<ijk_t> idx) {
    //        printf("in ");
    //        idx.dump();
