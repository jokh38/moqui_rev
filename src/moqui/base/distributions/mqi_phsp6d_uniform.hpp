#ifndef MQI_PHSP6D_UNIFORM_HPP
#define MQI_PHSP6D_UNIFORM_HPP
...
template <typename T> class phsp_6d_uniform : public pdf_Md<T, 6> {
...
public:
  ...
  /// Constructor to initializes mean, sigma, rho, and random engine
  CUDA_HOST_DEVICE
  phsp_6d_uniform(const std::array<T, 6> &m, const std::array<T, 6> &s,
