...
// namespace smc{
template <typename R> class gtr2_material_t : public patient_material_t<R> {
public:
...
/**
 * The <code>gtr2</code> class represents beam model for Sumitomo IMPT machine
 * in SMC
 */
template <typename T> class gtr2 : public treatment_machine_ion<T> {
protected:
public:
  ...
  gtr2() {
    ...
    std::vector<double> correctionProtonPerDose = {
        1,           1.087142586, 1.194654014, 1.30672804,  1.418493333,
        1.528336828, 1.635736563, 1.743366903, 1.85700629,  1.956866973,
        2.065896427, 2.165839877, 2.272688046, 2.389197949, 2.491620628,
        2.607891145, 2.728008023};
    protonPerDoseInterp.set_points(beamEnergyForProtonPerDose,
                                   correctionProtonPerDose,
                                   tk::spline::cspline);
    ...
    std::vector<double> correctionDosePerMUCount = {
        1,           1.013734192, 1.012925693, 0.998307125, 0.983342911,
        0.979028918, 0.967048299, 0.958585747, 0.946491263, 0.937642292,
        0.921448278, 0.904786882, 0.893353261, 0.884179113, 0.884545787,
        0.879304188, 0.871658754};
    dosePerMUCountInterp.set_points(beamEnergyForDosePerMUcount,
                                    correctionDosePerMUCount,
                                    tk::spline::cspline);
    ...
    std::vector<double> correctionBeamAngularSpread = {
        0.003615, 0.003495, 0.003815, 0.003695, 0.00354,  0.00334,
        0.003185, 0.00258,  0.002545, 0.00238,  0.002675, 0.00231,
        0.002285, 0.002135, 0.002255, 0.001845, 0.00201,  0.00197,
        0.00089,  0.001855, 0.00194,  0.00195,  0.00178,  0.001655,
  ...
  size_t characterize_history(const mqi::beam_module_ion::logspot &s) {
    ...
    int particleFromMUCount =
        s.muCount * protonPerDoseInterp(s.e) *
