...
/// \file
///
/// A coordinate transform to map a history from beamsource to map a IEC
/// coordinate or DICOM coordinate.
...
template <typename T> class coordinate_transform {
public:
  ...
  CUDA_HOST_DEVICE
  coordinate_transform(std::array<T, 4> &ang, vec3<T> &pos)
