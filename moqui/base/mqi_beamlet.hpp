...
/// Beamlet can be a a whole field (maybe double scattering) or a pencil beam of
/// IMPT Beamlet consists of 4 distributions
...
template <typename T> class beamlet {
protected:
  ...
  /// Coordinate transform to map local generation to patient or treatment
  /// coordination.
